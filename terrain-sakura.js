...
export default {
    ...
    getHeight(x, z, snoise) {
        ...
        let y = snoise(wx * 0.00065, wz * 0.00065) * 38.0;
        y += snoise(wx * 0.0016 + 20.0, wz * 0.0016 - 20.0) * 9.0;
        y += Math.abs(snoise(x * 0.004, z * 0.004)) * 1.8;

        const bluff = snoise(x * 0.0025, z * 0.0025);
        if (bluff > 0.2) {
            y += Math.pow(bluff - 0.2, 1.5) * 28.0;
        }
