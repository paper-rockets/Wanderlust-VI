...
export default {
    ...
    getHeight(x, z, snoise) {
        ...
        let y = snoise(wx * 0.0008, wz * 0.0008) * 35.0;
        y += snoise(wx * 0.0020 + 40.0, wz * 0.0020 - 40.0) * 10.0;
        y += Math.abs(snoise(x * 0.005, z * 0.005)) * 2.5;

        const hillNoise = snoise(x * 0.0005, z * 0.0005);
        if (hillNoise > 0.28) {
            y += Math.pow(hillNoise - 0.28, 1.6) * 45.0;
        }
