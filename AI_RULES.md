...
## 3. Servers — always give me TWO links
...
- Always give me BOTH links, clearly labelled:
    - "On this computer:"  the localhost link (for example http://localhost:8000)
    - "On your phone (same Wi-Fi):"  the network link (for example http://192.168.0.22:8000)
- My phone must be on the same Wi-Fi as this computer. If Windows Firewall blocks the phone link, tell me in plain words how to allow it.
